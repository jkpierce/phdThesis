...
\input{./gloss/gloss}	% always input, since other macros may rely on it
...
% CHAPTERS
\include{./ch1intro/ch1intro}
\include{./ch2bedEle/ch2bedEle}
\include{./ch3downDiff/ch3downDiff}
\include{./ch4simul/ch4simul}
\include{./ch5expt/ch5expt}
\include{./ch6conc/ch6conc}
