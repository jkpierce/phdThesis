...
\begin{table}
	...
	\end{tabular}
	\caption{Migration, entrainment, and deposition rates at $z(m)=0$ are tabulated from \citet{Ancey2008}. Units are $s^{-1}$ (probability/time). Bed elevation changes modulate these rates in accord with Eqs. \ref{eq:rate1}-\ref{eq:rate4}.}
	\label{tab:anceyparams}
	\end{center}
\end{table}
