...
Now I will demonstrate that weak collisions imply a Gaussian-like distribution for sediment velocities. The limit is challenging since the steady-state distribution \ref{eq:steadystate} and the moments above all diverge as $\ve \rightarrow 1$.
...
Incorporating this transformation into (\ref{eq:master}) provides the ``normalized" master equation
