...
The thesis includes two published works, Chapters \ref{ch:bedEle} and \ref{ch:downdiff}, available in \textit{Journal of Geophysical Research: Earth Surface} and \textit{Geophysical Research Letters} respectively with Marwan Hassan as coauthor \citep{Pierce2020a,Pierce2020b}. Chapters \ref{ch:flux} and \ref{ch:langevin} will be submitted for publication subsequent to submission of the thesis.
